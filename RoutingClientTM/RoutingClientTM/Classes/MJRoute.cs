...
namespace RoutingClientTM
{
    ...
    public class Resourceset
    {
        ...
        public ResourceMJ[] resources { get; set; }
    }

    public class ResourceMJ
    {
    ...
    {
        public object[] generalizations { get; set; }
    ...
    public class Endlocation
    {
        ...
        public AddressMJ address { get; set; }
